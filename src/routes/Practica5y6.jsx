...
import { PracticasContent } from '../components/PracticasContent'

export function Practica5y6() {
  useEffect(() => {
    // --------------------------------------------------------------------------------
  ...
  return (
    <div className='flex flex-col items-center justify-center w-full'>
      <Navbar />
      <Header title='Practica 5 y 6: Objetos en JavaScript y Continuación de Objetos' />
      <PracticasContent />
